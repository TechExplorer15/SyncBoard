    ...
    <div className="min-h-screen flex items-center justify-center bg-[#fafafa] px-4 selection:bg-brand-500 selection:text-white relative overflow-hidden">
      ...
      <div className="w-full max-w-[400px] relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-gray-500 mt-2 text-sm font-medium">Enter your details to access your workspaces.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="bg-white/70 backdrop-blur-xl rounded-3xl shadow-2xl shadow-gray-200/50 ring-1 ring-gray-900/5 p-8 space-y-5">
          ...
          <Button type="submit" isLoading={isLoading} className="w-full py-2.5 rounded-xl bg-gray-900 hover:bg-black text-white font-medium shadow-sm transition-all active:scale-[0.98] mt-2">
            Sign In
          </Button>
        </form>
        ...
        <p className="text-center text-sm font-medium text-gray-500 mt-8">
          ...
          <Link to="/register" className="text-gray-900 hover:text-brand-600 transition-colors underline decoration-gray-300 hover:decoration-brand-600 underline-offset-4">
            Create one now
          </Link>
        </p>
      </div>
